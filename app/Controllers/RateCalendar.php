...
class RateCalendar extends APIBaseController
{
    ...
    public function create()
    {
        ...
        if (fmod($daily_rate_baserate, 1) !== 0.0) {
            return $this->notifyError(
        ...
        if (fmod($daily_rate_guesttype_1, 1) !== 0.0) {
            return $this->notifyError(
        ...
        if (fmod($daily_rate_guesttype_2, 1) !== 0.0) {
            return $this->notifyError(
        ...
        if (fmod($daily_rate_guesttype_3, 1) !== 0.0) {
            return $this->notifyError(
        ...
        if (fmod($daily_rate_guesttype_4, 1) !== 0.0) {
            return $this->notifyError(
        ...
        $new_id = $rate_calendar_model->insert(
            $rate_calendar_data
        );
        if ($new_id == null) {
            return $this->notifyError(
    ...
    public function update($id = null)
    {
        ...
        /* Getting data from raw */
        $daily_rate_id = $this->request->getVar(
            'daily_rate_id'
        );
        $daily_rate_code = $this->request->getVar(
            'daily_rate_code'
        ...
        if (!ctype_digit((string) $daily_rate_id)) {
            return $this->notifyError(
                'daily_rate_id format is incorrect'
            );
        }
        if (!ctype_digit((string) $daily_rate_code)) {
            return $this->notifyError(
