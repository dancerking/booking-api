...
class Code extends APIBaseController
{
    ...
    public function index()
    {
        ...
        $main_host_data = $host_model->get_host_data(
            $host_id
        );
        ...
        $mapped_host_types = $types_mapping_model->get_mapping_types(
            $host_id,
            $record_status
        );
        ...
        $mapped_filters = $filter_mapping_model->get_mapped_filters(
            $host_id,
            $record_status
        );
        $photo_contents = $photo_content_model->get_photo_contents(
            $host_id,
            $record_status
        );
        ...
        return $this->respond([
            ...
            'available_languages' =>
                $available_languages == null
                    ? []
                    : $available_languages,
            'available_main_types' =>
                $available_main_types == null
                    ? []
                    : $available_main_types,
            'mapped_host_types' =>
                $mapped_host_types == null
                    ? []
                    : $mapped_host_types,
            'available_guest_types' =>
                $available_guest_types == null
                    ? []
                    : $available_guest_types,
