...
class TypeAvailabilityModel extends Model
{
    ...
    public function get_availability_types($host_id, $type_availability_code, $from, $to) {
        $query   = $this->db->query('SELECT type_availability_code, type_availability_day, type_availability_qty, type_availability_msa, type_availability_coa, type_availability_cod
